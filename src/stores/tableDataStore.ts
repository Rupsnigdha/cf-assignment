...
import { ExecutionRecord } from "@/components/dashboard/columns";
...
interface TableDataState {
  ...
  setFilterKey: (i: string) => void;
}

const initialData: ExecutionRecord[] = [
  {
    execId: "exec-001",
    execUser: "alice@gmail.com",
    status: "SUCCESS",
    latency: 120,
...
export const useTableDataStore = create<TableDataState>((set) => ({
  ...
  setFilterKey: (i) => set(() => ({selectedFilterKey: i})),
